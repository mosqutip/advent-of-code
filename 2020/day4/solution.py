...
def process_passport(passport: {str: str}, validate: bool = False) -> int:
    keys: set(str) = set(passport.keys())
    if required_fields.difference(keys):
        return 0
    ...
    if validate:
        ...
        if birth_year[1] and (birth_year[0] < 1920 or birth_year[0] > 2002):
            return 0
        if issue_year[1] and (issue_year[0] < 2010 or issue_year[0] > 2020):
            return 0
...
print(count_valid_passports(True))
