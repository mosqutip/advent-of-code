...
class Day09()
{
    private static List<string> inputFileLines = Utilites.ReadInputFile("09");
    ...
    private static int solvePartOne()
    {
        ...
        foreach (var line in inputFileLines)
        {
            ...
            List<int> lastValues = new List<int>() { values.Last() };
            while (true)
            {
                int firstDifference = values[1] - values[0];
                List<int> differences = new List<int>() { firstDifference };
                ...
                if (differences.All(item => item == 0))
                {
                    break;
                }
                else
                {
                    lastValues.Add(differences.Last());
                    values = differences;
                }
            }
